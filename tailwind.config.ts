...
export default {
  // Dark mode removed - single light theme only
  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        // Unified reveal animation - fade + translateY only
        "reveal-up": {
      ...
      animation: {
        ...
        // Primary reveal: 0.6-0.8s with power2.out easing
