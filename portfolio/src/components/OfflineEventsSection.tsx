...
const coinfest3 = `${STORAGE_URL}/events/coinfest-3.jpg`;
const hackerhouse1 = `${STORAGE_URL}/events/hackerhouse-1.jpg`;
const hackerhouse2 = `${STORAGE_URL}/events/hackerhouse-2.jpg`;
const hackerhouse3 = `${STORAGE_URL}/events/hackerhouse-3.jpg`;
const bandung1 = `${STORAGE_URL}/events/bandung-1.jpg`;
const bandung2 = `${STORAGE_URL}/events/bandung-2.jpg`;
const bandung3 = `${STORAGE_URL}/events/bandung-3.jpg`;
const ibw1 = `${STORAGE_URL}/events/ibw-1.jpg`;
const ibw2 = `${STORAGE_URL}/events/ibw-2.jpg`;
const ibw3 = `${STORAGE_URL}/events/ibw-3.jpg`;
const coinfest2024_1 = `${STORAGE_URL}/events/coinfest2024-1.jpg`;
const coinfest2024_2 = `${STORAGE_URL}/events/coinfest2024-2.jpg`;
const coinfest2024_3 = `${STORAGE_URL}/events/coinfest2024-3.jpg`;
const coinfest2025_1 = `${STORAGE_URL}/events/coinfest2025-1.jpg`;
const coinfest2025_2 = `${STORAGE_URL}/events/coinfest2025-2.jpg`;
const coinfest2025_3 = `${STORAGE_URL}/events/coinfest2025-3.jpg`;
const web3bandung1 = `${STORAGE_URL}/events/web3bandung-1.jpg`;
const web3bandung2 = `${STORAGE_URL}/events/web3bandung-2.jpg`;
const web3bandung3 = `${STORAGE_URL}/events/web3bandung-3.jpg`;
const hackerhousemanta1 = `${STORAGE_URL}/events/hackerhousemanta-1.jpg`;
const hackerhousemanta2 = `${STORAGE_URL}/events/hackerhousemanta-2.jpg`;
const hackerhousemanta3 = `${STORAGE_URL}/events/hackerhousemanta-3.jpg`;
