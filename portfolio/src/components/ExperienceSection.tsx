...
const clipperLogo = `${STORAGE_URL}/logos/clipper.jpg`;
const sqdLogo = `${STORAGE_URL}/logos/sqd.jpg`;
const aztecLogo = `${STORAGE_URL}/logos/aztec.jpg`;
const junkfunLogo = `${STORAGE_URL}/logos/junkfun.jpg`;
const superfortuneLogo = `${STORAGE_URL}/logos/superfortune.jpg`;
